...
ggplot() + 
  geom_line(data = db1, aes(x = rb1, y = sb1["x1",]), size = 2, colour = "coral1")+
  ...
  ggtitle("Vpliv koeficienta b1 na rešitev x, y, z in w")+
...
#Graf za resitve x,y,z in w
ggplot() + 
  geom_line(data = dc3, aes(x = rc3, y = sc3["x1",]), size = 2, colour = "coral1")+
...
#Graf za optimalno vrednost
ggplot() + 
  geom_line(data = dc3, aes(x = rc3, y = sc3["value.b",]), size = 2, colour = "mediumpurple1")+
...
#Graf za resitve x,y,z in w
ggplot() + 
  geom_line(data = dc4, aes(x = rc4, y = sc4["x1",]), size = 2, colour = "coral1")+
...
#Graf za optimalno vrednost
ggplot() + 
  geom_line(data = dc4, aes(x = rc4, y = sc4["value.b",]), size = 2, colour = "mediumpurple1")+
